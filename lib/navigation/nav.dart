  ...
  static List<BottomNavigationBarItem> generateIcons(List<int> featureList) {
    List<BottomNavigationBarItem> _navigationBarList = <BottomNavigationBarItem>[
      BottomNavigationBarItem(
        icon: Icon(Icons.home, color: Color(int.parse(FitnessPackage.model.secondaryColor))),
        label: "Overview",
      ),
    ];
      ...
      switch(element){
        case 0:
          _navigationBarList.add(BottomNavigationBarItem(
            icon: Icon(Icons.calendar_today, color: Color(int.parse(FitnessPackage.model.secondaryColor)),),
            label: "Bookings",
          ));
          break;
        case 1:
          _navigationBarList.add(BottomNavigationBarItem(
            icon: Icon(Icons.fitness_center, color: Color(int.parse(FitnessPackage.model.secondaryColor))),
            label: "Weight Goal",
          ),);
          break;
        case 2:
          _navigationBarList.add(BottomNavigationBarItem(
            icon: Icon(Icons.info_rounded, color: Color(int.parse(FitnessPackage.model.secondaryColor))),
            label: "Information",
          ));
          break;
      }
    ...
    _navigationBarList.add(BottomNavigationBarItem(
      icon: Icon(Icons.menu, color: Color(int.parse(FitnessPackage.model.secondaryColor))),
      label: "More",
    ));
