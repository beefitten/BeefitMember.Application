...
class BookingListBloc extends Bloc<BookingListEvents, BookingListState> {
  ...
  BookingListBloc(BookingListState initialState, this.service) : super(initialState);
  ...
  Stream<BookingListState> mapEventToState(BookingListEvents event) async* {
    ...
    if (event is BookingListLoadingEvent) {
      ...
      if (bookings == "error"){
        ...
        yield BookingListSuccessState(yourBookings: bookings[0], allBookings: bookings[1]);
      }
    } else {
